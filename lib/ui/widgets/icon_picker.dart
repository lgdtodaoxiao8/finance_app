...
class IconPicker extends StatefulWidget {
  ...
  static const List<IconData> handleIcons = [
...
class _IconPickerState extends State<IconPicker> {
                ...
                child: Row(
                  ...
                  children: [
                    PopupDropdownSimple(
                      ...
                      values: ['All', ...IconPicker.categorizedIcons.keys],
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    if (_selectedCategory == 'All') {
                      icon = IconPicker.categorizedIcons.values
                          .expand((i) => i)
                          .toList()[index];
                    } else {
                      icon = IconPicker
                          .categorizedIcons[_selectedCategory]![index];
                    }
                  ...
                  itemCount: _selectedCategory == 'All'
                      ? IconPicker.categorizedIcons.values
                            .expand((i) => i)
                            .length
                      : IconPicker.categorizedIcons[_selectedCategory]!.length,
                ),
              ),
  ...
  //                             .length
  //                       : IconPicker
  //                             .categorizedIcons[_selectedCategory]!
  //                             .length,
  //                 ),
  //               ),
  //               IconButton(
